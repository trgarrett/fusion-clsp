...
class TestNftUtils:
    ...
    async def test_calculate_nft_full_puzzle_hash(self):
        result: Program = CALCULATE_NFT_FULL_PUZZLE_HASH_MOD.run([
            ...
            SINGLETON_LAUNCHER_HASH,
            NFT_STATE_LAYER_MOD_HASH,
            bytes32.from_hexstr("0x059265da2dfa0dc477dd43ff9b4648d067341143ecaa3165b1e4202d07863dd1"), #METADATA_UPDATER_PUZZLE_HASH_HASH,
            bytes32.from_hexstr("0xd9eb1eb2bd59d44e937e44dbfd9d70f8c593893eae1f86e363764401fa58d802"), #launcher ID
            bytes32.from_hexstr("0xcb699f353e6066cdfd34abc003e1c029cbd34c069ed42f9233a95b9419058662"), #metadata hash
            bytes32.from_hexstr("0x5bf47b4ac39c66c5fd2247a623acc22500254d2574d0b4496ec9ed36cd3c1847") # inner puzzlehash
        ])
        expected: Program = Program.to(bytes32.from_hexstr("0x2efafb3fd337152d1f9872508195e61a54cddb697e9f0a0e83a316d9e4e5ae95"))
